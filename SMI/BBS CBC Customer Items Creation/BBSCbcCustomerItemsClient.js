...
function customerItemsFieldChanged(type, name, linenum)
{
	...
	//If the grade has been changed, then save the selected value
	//
	if (name == 'custpage_grade_select')
		{
			//Get the selected finish item
			//
			var gradeId = nlapiGetFieldValue('custpage_grade_select');
			var gradeTxt = nlapiGetFieldText('custpage_grade_select');
			
			//Save the selected finish item for later retrieval in the POST section
			//
			nlapiSetFieldValue('custpage_grade_id_param', gradeId, false, true);
			nlapiSetFieldValue('custpage_grade_txt_param', gradeTxt, false, true);
		}

	
	//If the budget type has been changed, then save the selected value
	//
	if (name == 'custpage_budget_type_select')
		{
			//Get the selected finish item
			//
			var budgetId = nlapiGetFieldValue('custpage_budget_type_select');
			var budgetTxt = nlapiGetFieldText('custpage_budget_type_select');
			
			//Save the selected finish item for later retrieval in the POST section
			//
			nlapiSetFieldValue('custpage_budget_id_param', budgetId, false, true);
			nlapiSetFieldValue('custpage_budget_txt_param', budgetTxt, false, true);
		}
