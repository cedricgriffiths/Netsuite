...
function matrixOutputSuitelet(request, response)
{
	...
	if (request.getMethod() == 'GET') 
	{
		...
		//Body
		//
		xml += "<body header=\"nlheader\" header-height=\"29%\" footer=\"nlfooter\" footer-height=\"1%\" padding=\"0.5in 0.5in 0.5in 0.5in\" size=\"A4\">";
		...
		xml += "<table style=\"width: 100%\">";
		xml += "<tr>";
		xml += "<td align=\"left\" colspan=\"4\" style=\"font-size:12px;\"><b>Product</b></td>";
		xml += "<td align=\"left\" colspan=\"12\" style=\"font-size:12px;\">" + nlapiEscapeXML(parentDescription) + "</td>";
		xml += "</tr>";
		xml += "</table>\n";
		xml += "<p></p>";
