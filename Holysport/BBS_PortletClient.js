...
function clientFieldChanged(type, name, linenum) {
	...
	if (name == 'custpage_select') {
		...
		if (selectSearch != null && selectSearch != '') {
			...
			//
			var googleSearchRecord = nlapiLoadRecord('customrecord_bbs_google_map_searches', selectSearch);

			if (googleSearchRecord != null) {

				//Get the id of the saved search
				//
				var searchId = googleSearchRecord.getFieldValue('custrecord_bbs_saved_search');
