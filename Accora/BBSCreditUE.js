 ...
 * @returns {Void}
 */
function credExportBeforeLoad(type, form, request)
{
	//Add the export button to the form
	//
	if (type == 'edit')
		{
			form.addButton('custpage_butt_export', 'Export DSSI Credit Invoice', 'exportCredit');
		}
	...
	if (type == 'view') 
	{
		...
		form.addButton('custpage_butt_export', 'Export DSSI Credit Invoice', 'glbExportCredit');
	}
}
