 ...
 * @returns {Void}
 */
function salesExportBeforeLoad(type, form, request)
{
	//Add the export button to the form
	//
	if (type == 'edit')
		{
			form.addButton('custpage_butt_export', 'Export DSSI Order Ack', 'exportOrderAck');
		}
	...
	if (type == 'view') 
		{
			...
			form.addButton('custpage_butt_export', 'Export DSSI Order Ack', 'glbExportOrderAck');
		}
}
